...
class ElevationMappingNode : public rclcpp::Node
{
   public:
    ...
    using CameraChannelPolicy =
        message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::Image, sensor_msgs::msg::CameraInfo,
                                                        elevation_map_msgs::msg::ChannelInfo>;
    ...
    // using PointCloudPolicy = message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::PointCloud2,
    // elevation_map_msgs::msg::ChannelInfo>; using PointCloudSync = message_filters::Synchronizer<PointCloudPolicy>;
   ...
   private:
    ...
    void inputPointCloud(const sensor_msgs::msg::PointCloud2::ConstSharedPtr cloud,
    ...
    // sensor_msgs::msg::CameraInfo::SharedPtr camera_info_msg, const std::string& key); void imageChannelCallback(const
    // sensor_msgs::msg::Image::SharedPtr image_msg, const sensor_msgs::msg::CameraInfo::SharedPtr camera_info_msg,
    // const elevation_map_msgs::msg::ChannelInfo::SharedPtr channel_info_msg);
    void imageCallback(const sensor_msgs::msg::Image::SharedPtr cloud, const std::string& key);
    void imageChannelCallback(const elevation_map_msgs::msg::ChannelInfo::SharedPtr chennel_info,
                              const std::string& key);
    void imageInfoCallback(const sensor_msgs::msg::CameraInfo::SharedPtr image_info, const std::string& key);
    //   void pointCloudChannelCallback(const sensor_msgs::PointCloud2& cloud, const
    //   elevation_map_msgs::ChannelInfoConstPtr& channel_info_msg);
    //   // void multiLayerImageCallback(const elevation_map_msgs::MultiLayerImageConstPtr& image_msg, const
    //   sensor_msgs::CameraInfoConstPtr& camera_info_msg);
    void publishAsPointCloud(const grid_map::GridMap& map) const;
    bool getSubmap(const std::shared_ptr<grid_map_msgs::srv::GetGridMap::Request> request,
                   std::shared_ptr<grid_map_msgs::srv::GetGridMap::Response> response);

    //   bool checkSafety(elevation_map_msgs::CheckSafety::Request& request, elevation_map_msgs::CheckSafety::Response&
    //   response);

    void initializeMap(const std::shared_ptr<elevation_map_msgs::srv::Initialize::Request> request,
                       std::shared_ptr<elevation_map_msgs::srv::Initialize::Response> response);
    void clearMap(const std::shared_ptr<std_srvs::srv::Empty::Request> request,
                  std::shared_ptr<std_srvs::srv::Empty::Response> response);
    void clearMapWithInitializer(const std::shared_ptr<std_srvs::srv::Empty::Request> request,
                                 std::shared_ptr<std_srvs::srv::Empty::Response> response);
    ...
    visualization_msgs::msg::Marker vectorToArrowMarker(const Eigen::Vector3d& start, const Eigen::Vector3d& end,
                                                        const int id) const;
